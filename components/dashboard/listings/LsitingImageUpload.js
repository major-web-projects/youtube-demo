...
function ListingImageUpload() {
  ...
  const {
    ...
    onDrop: (acceptedFiles) => {
      ...
      dispatch(listingAction.upload({ formData, listingId })).then(() => {
      ...
      return (
        ...
        >
          <div style={thumbInner}>
            <Image height="100px" width="100px" src={imgUrl} alt="image" />
          </div>
  ...
  useEffect(() => {
    ...
    if (listingRead && listingRead.images.length !== 0) {
      setFiles(listingRead.images);
    }
    return () => {
